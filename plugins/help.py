...
async def cb_help(bot: Client, CallbackQuery):
  ...
  if data == "inr_p":
    await CallbackQuery.message.edit(PLAN_INR, reply_markup=BTN_1)
  elif data == "usd_p":
    await CallbackQuery.message.edit(PLAN_USD, reply_markup=BTN_2)
