...
async def search(bot, message):
    ...
    try:
        ...
        total_time = f"Searched in {elapsed_time:.2f} sec." # Add the duration to the footer
        msg = await message.reply_text(text=results + total_time, disable_web_page_preview=True)
